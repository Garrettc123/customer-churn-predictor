...
# Allowed origins - restrict to known frontends in production
...
app.add_middleware(
    ...
    allow_credentials=False,  # FIX: False is safe with specific origins
...
def get_retention_actions(
    probability: float, features: CustomerFeatures
) -> List[str]:
...
async def predict_churn(request: PredictionRequest):
    ...
    days_until_churn = int((1 - probability) * 90)
